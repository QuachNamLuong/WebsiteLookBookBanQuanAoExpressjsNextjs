  ...
  const blogs = [
    {
      ...
      excerpt: "Một bộ sưu tập lấy cảm hứng từ miền ký ức và những gam màu đa sắc.",
    ...
    },
    {
      ...
      excerpt: "Khám phá ẩm thực mùa thu Hà Nội với những món ăn đặc trưng.",
    ...
    },
    {
      ...
      excerpt: "Khi di sản và thời trang giao thoa trong chiếc nón lụa truyền thống.",
    ...
    },
    {
      ...
      excerpt: "Danh sách những địa điểm lý tưởng để chụp ảnh áo dài.",
    ...
    },
    {
      ...
      excerpt: "Phụ kiện mùa hè giúp tôn vinh nét duyên Việt.",
    ...
    },
    {
      ...
      excerpt: "Mẹo nhỏ để giữ áo dài luôn bền đẹp theo thời gian.",
    ...
    ...Array.from({ length: 29 }, (_, i) => {
        ...
        excerpt: `Đây là đoạn mô tả ngắn gọn cho bài viết demo số ${id}.`,
