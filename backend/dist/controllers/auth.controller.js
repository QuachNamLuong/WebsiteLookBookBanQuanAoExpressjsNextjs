...
export const register = async (req, res) => {
    ...
    const { accessToken, refreshToken } = await AuthSerivce.registerCustomer(username, email, password);
...
export const login = async (req, res) => {
    ...
    const { accessToken, refreshToken } = await AuthSerivce.login(username, password);
